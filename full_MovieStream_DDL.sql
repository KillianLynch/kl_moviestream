...
--Create the customer_contact table 
...
/*CREATE INDEX CUSTOMER_SIDX ON CUSTOMER_CONTACT 
    INDEXTYPE IS MDSYS.SPATIAL_INDEX_V2 
    PARAMETERS ('layer_gtype=POINT');*/

CREATE UNIQUE INDEX PK_CUSTCONTACT_CUST_ID ON CUSTOMER_CONTACT 
    ( 
     CUST_ID ASC 
    );

ALTER TABLE CUSTOMER_CONTACT 
    ADD CONSTRAINT PK_CUSTCONTACT_CUST_ID PRIMARY KEY ( CUST_ID ) 
    USING INDEX PK_CUSTCONTACT_CUST_ID ;

-----------------------------------

--create the customer_extention table
...
CREATE UNIQUE INDEX PK_CUSTEXTENSION_CUST_ID ON CUSTOMER_EXTENSION 
    ( 
     CUST_ID ASC 
    );

ALTER TABLE CUSTOMER_EXTENSION 
    ADD CONSTRAINT PK_CUSTEXTENSION_CUST_ID PRIMARY KEY ( CUST_ID ) 
    USING INDEX PK_CUSTEXTENSION_CUST_ID ;
--------------------------

--Create the customer_promotions table
...
CREATE UNIQUE INDEX CUSTOMER_PROMOTIONS_PK ON CUSTOMER_PROMOTIONS 
    ( 
     CUST_ID ASC 
    );

ALTER TABLE CUSTOMER_PROMOTIONS 
    ADD CONSTRAINT CUSTOMER_PROMOTIONS_PK PRIMARY KEY ( CUST_ID ) 
    USING INDEX CUSTOMER_PROMOTIONS_PK ;
----------------------------------------
...
--create the pizza_location table 
...
/*CREATE INDEX PIZZA_LOCATION_SIDX ON PIZZA_LOCATION 
    ( 
     ADMIN
    ) 
    INDEXTYPE IS MDSYS.SPATIAL_INDEX_V2 
...
CREATE UNIQUE INDEX PK_PIZZA_LOC_ID ON PIZZA_LOCATION 
    ( 
     PIZZA_LOC_ID ASC 
    );
ALTER TABLE PIZZA_LOCATION 
    ADD CONSTRAINT PK_PIZZA_LOC_ID PRIMARY KEY ( PIZZA_LOC_ID ) 
    USING INDEX PK_PIZZA_LOC_ID ;
-----------------------------------------------------------------
...
CREATE UNIQUE INDEX PK_DAY ON TIME 
    ( 
     DAY_ID ASC 
    );
